...
public class AppHuaihe {
    public static void main(String[] args) throws IOException {
        writeHuaiheToHbase();
    }

    public static void writeHuaiheToHbase() throws IOException {
        System.out.println("HanJiang任务启动!");
        String directory = "F:\\Transwarp_Data\\evaporation2010-2018\\evaporation2010-2018\\evaporation2010-2018\\huaihe";
        String latLonFilePath = "F:\\Transwarp_Data\\LatLon\\LatLon\\ET_1Day_1km_huaihe_20140924.h5";
