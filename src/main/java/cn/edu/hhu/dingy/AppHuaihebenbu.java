...
public class AppHuaihebenbu {
    public static void main(String[] args) throws IOException {
        writeHuaihebenbuToHbase();
    }

    public static void writeHuaihebenbuToHbase() throws IOException {
        System.out.println("HanJiang任务启动!");
        String directory = "F:\\Transwarp_Data\\evaporation2010-2018\\evaporation2010-2018\\evaporation2010-2018\\huaiheBengbu";
        String latLonFilePath = "F:\\Transwarp_Data\\LatLon\\LatLon\\ET_1Day_1km_huaiheBengbu_20170820.h5";
        List<String> hdf5FilesList = TraverseDirectoryFiles.nonRecursionTraverseFolder(directory);
        String tableName = "ET_1Day_1km_huaiheBengbu";
