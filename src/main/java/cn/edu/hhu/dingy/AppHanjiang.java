...
public class AppHanjiang {
    ...
    public static void writeHanJiangToHbase() throws IOException {
        ...
        String directory = "F:\\Transwarp_Data\\evaporation2010-2018\\evaporation2010-2018\\evaporation2010-2018\\hanjiang";
        String latLonFilePath = "F:\\Transwarp_Data\\LatLon\\LatLon\\ET_1Day_1km_hanjiang_20180302.h5";
        List<String> hdf5FilesList = TraverseDirectoryFiles.nonRecursionTraverseFolder(directory);
        String tableName = "ET_1Day_1km_hanjiang";
